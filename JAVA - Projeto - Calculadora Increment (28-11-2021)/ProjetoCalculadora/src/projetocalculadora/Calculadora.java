...
public class Calculadora extends javax.swing.JFrame {
    ...
    public Calculadora() {
        initComponents();
        jRadioButton1.setEnabled(false); //desabilitar o ON
    }
    ...
    public void arithmetic(){
        switch(calculation){
            ...
            case 5: //Ao Quadrado               
                num *= num;
                textField1.setText(Double.toString(num));
                break;  
    ...
    private void initComponents() {
        ...
        jButton20.setFont(new java.awt.Font("Arial Black", 1, 11)); // NOI18N
        jButton20.setText("x²");
        jButton20.setActionCommand("2");
        ...
        jButton23.setFont(new java.awt.Font("Arial Black", 1, 17)); // NOI18N
        jButton23.setText("√");
        ...
        jButton24.setFont(new java.awt.Font("Arial Black", 1, 11)); // NOI18N
        jButton24.setText("n!");
    ...
    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
        int length = textField1.getText().length(); //comprimento
        int number = textField1.getText().length() - 1; //diminui 1
        String store; //string com nome store

        if(length > 0){ //se não estiver vazio
            StringBuilder back = new StringBuilder(textField1.getText()); //cria e manupula dados de strings dinâmicas
            back.deleteCharAt(number); //diminuiu 1
            store = back.toString();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        textField1.setText(null); //C - Limpar Text
